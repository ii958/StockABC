...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockAvgPrice.aspx.cs" Inherits="AISRS.WebUI.DataCenter.StockAvgPrice" %>
<%@ Register TagPrefix="uc1" TagName="Footer" Src="../Modules/Footer.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >

<html>
	<head>
		<title>股票系统--均价计算</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table id="table1" cellpadding="1" cellspacing="1" border="0" width="100%">
				...
				<tr>
					<td></td>
                    <td></td>					
					<td><uc1:LinkButton id="LinkButtonImport" runat="server" Text="计算"></uc1:LinkButton></td>                   
					<td></td>
				</tr>
			</table>
			<uc1:SubHeader id="SubHeader1" runat="server" title="均价计算结果列表"></uc1:SubHeader>
