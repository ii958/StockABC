<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockBuyHistoryExport.aspx.cs" Inherits="AISRS.WebUI.Index.StockBuyHistoryExport" contentType="application/vnd.ms-excel"%>
...
<html>
	...
	<body style="margin-left:0; margin-top:0;">
		<form id="Form1" method="post" runat="server">
			...
			<uc1:BmBlafTable id="BmBlafTableHistory" runat="server"></uc1:BmBlafTable>
		</form>
	</body>
</html>
