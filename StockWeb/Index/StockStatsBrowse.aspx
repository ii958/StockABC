<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockStatsBrowse.aspx.cs" Inherits="AISRS.WebUI.Index.StockStatsBrowse" %>
...
<html>
    ...
    <body>
		<form id="Form1" method="post" runat="server">
			...
			<uc1:Header id="Header1" runat="server" title="股票涨跌统计"></uc1:Header>
            ...
            <uc1:SubHeader id="SubHeader1" runat="server" title="股票涨跌统计列表"></uc1:SubHeader>
