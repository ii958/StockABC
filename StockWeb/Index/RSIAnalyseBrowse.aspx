<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RSIAnalyseBrowse.aspx.cs" Inherits="AISRS.WebUI.Index.RSIAnalyseBrowse" %>
...
<html>
    ...
    <body>
		<form id="Form1" method="post" runat="server">
			...
			<uc1:Header id="Header1" runat="server" title="RSI指标分析"></uc1:Header>
            ...
            <uc1:SubHeader id="SubHeader1" runat="server" title="RSI指标分析列表"></uc1:SubHeader>
