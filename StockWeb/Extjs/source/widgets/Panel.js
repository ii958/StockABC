...
Ext.Panel = Ext.extend(Ext.Container, {
     ...
     * {@link #bwrap}      div      {@link #baseCls}+'-bwrap'     {@link #bwrAISRSfg}    bwrAISRSssClass    bwrapStyle
...
new Ext.Panel({
    ...
    onRender : function(ct, position){
        ...
        if(d.firstChild){ // existing markup
            ...
            this.bwrap = el.down('.'+this.bwrAISRSls);
...
panel.load({
    ...
    createClasses : function(){
        ...
        this.bwrAISRSls = this.baseCls + '-bwrap';
