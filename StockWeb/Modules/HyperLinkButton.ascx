<%@ Control Language="c#" AutoEventWireup="false" Codebehind="HyperLinkButton.ascx.cs" Inherits="AISRS.WebUI.Modules.HyperLinkButton" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<div style="<%=_visible%>">
<table cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td class="OraBGAccentLight OraNav6Selected" valign="middle" align="left" height="22"
			nowrap="nowrap">
			<asp:HyperLink ID="HyperLinkAction" Runat="server"></asp:HyperLink>
		</td>
	</tr>
	<tr>
