...
namespace AISRS.Common.Function
{
    public class EmailUtil
    {
        ...
        public EmailUtil(string server, string toMail, string fromMail, string subject, string emailBody, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
                ...
                this.mSenderUsername = "476707501@qq.com";
                this.mSenderPassword = "Wbgsnwbd1!090";
